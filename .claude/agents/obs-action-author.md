...
description: >-
  ...
  the declarative Action pattern, with correct thread-safe OBS access. Use
  when the user wants to add an action, extend the OBS catalogue, or expose
  more of the obs-websocket API on a key.
tools: Read, Write, Edit, Grep, Glob, Bash
model: sonnet
---
<!-- Generated from agent-definitions/prompts/obs-action-author.md by agent-definitions/sync.py. -->

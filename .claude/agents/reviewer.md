...
description: >-
  ...
  config-isolation, single-instance, EventBus, built-in game ownership, and
  English-only invariants. Use proactively after changes to obs/, device/,
  games/, core/icons.py, core/controller.py, core/events.py, or ui/, and
